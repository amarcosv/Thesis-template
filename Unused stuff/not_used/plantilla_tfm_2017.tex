...
% Encontrarás un ejemplo de TFM realizado con esta misma plantilla en el archivo "ejemplo_TFM_2017.zip", incluido en la misma carpeta. Consúltalo porque contiene ejemplos útiles para incorporar tablas, figuras, listados de código, bibliografía, etc.
...
% soporte para generar PDF/A --es importante de cara a su inclusión en e-Archivo porque es el formato óptimo de preservación y a la generación de metadatos, tal y como se describe en http://uc3m.libguides.com/ld.php?content_id=31389625. En la carpeta incluímos el archivo plantilla_tfm_2017.xmpdata en el que puedes incluir los metadatos que se incorporarán al archivo PDF cuando lo compiles. Ese archivo debe llamarse igual que tu archivo .tex
...
\DefineBibliographyStrings{english}{
	url = {\adddot\space[On line]\adddot\space Available at:}
}
\DefineBibliographyStrings{english}{
	urlseen = {URL:}
}
...
\begin{titlepage}
	...
	\begin{center}
		...
		\begin{Large}
			...
			2018-2019\\
			\vspace{2cm}		
			\textsl{Tesis Doctoral}
			\bigskip
			
		\end{Large}
		 	{\Huge ``Como hacer magias con PET''}\\
		 	\vspace*{0.5cm}
	 		\rule{10.5cm}{0.1mm}\\
			\vspace*{0.9cm}
			{\LARGE Rigoberto Chil Pérez}\\ 
			\vspace*{1cm}
		\begin{Large}
			Tutor/es\\
			Juan José Vaquero López\\
			UC3M Campus Leganés - Mayo 2018\\
		\end{Large}
	\end{center}
	\vfill
	\color{black}
...
\chapter{Electronic Personal Dosimeter}
